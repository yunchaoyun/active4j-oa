...
<html>
<head>
<t:base type="default,treeview,laydate,icheck"></t:base>
</head>
<body class="gray-bg">
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="row">
						...
						<div class="col-sm-8">
							<t:formvalid action="oa/hr/specialtime/saveAdd">
								<div class="panel panel-default">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label m-b">类型：</label>
											<div class="col-sm-4 m-b">
												<t:dictSelect name="type" type="select" typeGroupCode="oaspecialtype" defaultVal="0"></t:dictSelect>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label m-b">时间 从：</label>
											<div class="col-sm-4 m-b">
												<input class="laydate-icon form-control layer-date" id="startTime" name="startTime" required="">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label m-b">到：</label>
											<div class="col-sm-4 m-b">
												<input class="laydate-icon form-control layer-date" id="endTime" name="endTime" required="">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label m-b">合计小时数：</label>
											<div class="col-sm-4 m-b">
										...
										<div class="form-group">
                              			    <label class="col-sm-3 control-label">是否生成加班数据：</label>
			                                <div class="col-sm-6">
			                                	<t:dictSelect name="generate" type="radio" typeGroupCode="byesorno" defaultVal="false"></t:dictSelect>
			                                </div>
                            			</div>
                            			<div class="form-group">
                              			    <label class="col-sm-3 control-label">是否生成年假数据：</label>
			                                <div class="col-sm-6">
			                                	<t:dictSelect name="isYear" type="radio" typeGroupCode="byesorno" defaultVal="false"></t:dictSelect>
			                                </div>
                            			</div>
									</div>
								</div>
