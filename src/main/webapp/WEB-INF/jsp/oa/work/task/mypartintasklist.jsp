...
<body class="gray-bg">
					...
					<div class="col-sm-9">
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="ibox">
									<div class="ibox-content">
										<div id="oaWorkMyPartinTaskListTable" class="jqGrid_wrapper"></div>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- 脚本部分 -->
	<t:datagrid actionUrl="oa/work/task/mypartintaskdatagrid" tableContentId="oaWorkMyPartinTaskListTable" searchGroupId="searchGroupId" fit="true" caption="我参与的任务列表" name="oaWorkMyCreateTaskList" pageSize="20" sortName="createDate" sortOrder="desc" load="true" loadFun="init();">
...
<script type="text/javascript">
	...
	function searchAction(status) {
		var name = $("#title").val();
		$("#oaWorkMyPartinTaskListTable").jqGrid('setGridParam', {postData:{status:status,title:name}}).trigger('reloadGrid');
