...
<body class="gray-bg">
					...
					<div class="col-sm-9">
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="ibox">
									<div class="ibox-content">
										<div id="oaWorkMyMonitorTaskListTable" class="jqGrid_wrapper"></div>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- 脚本部分 -->
	<t:datagrid actionUrl="oa/work/task/mymonitortaskdatagrid" tableContentId="oaWorkMyMonitorTaskListTable" searchGroupId="searchGroupId" fit="true" caption="我监控的任务列表" name="oaWorkMyMonitorTaskList" pageSize="20" sortName="createDate" sortOrder="desc" load="true" loadFun="init();">
...
<script type="text/javascript">
	...
	function searchAction(status) {
		var name = $("#title").val();
		$("#oaWorkMyMonitorTaskList").jqGrid('setGridParam', {postData:{status:status,title:name}}).trigger('reloadGrid');
